    ...
    <div className='py-24'>
      <div className=' rounded-sm text-2xl text-black '>
        ...
        <div className='flex flex-wrap justify-between '>
          {courses.map((course) =>
            <div className='bg-white flex-col  mb-10 lg:basis-8/25 sm:basis-12/25  justify-center align-middle px-6 rounded-sm border-1  border-[#7F8C8D] py-10'>
              ...
              <button className='bg-[#00A36C] p-6 rounded-xl!  w-full  text-white text-base mt-4'>Select Course</button>
            </div>)}
        </div>
      </div>
    </div>
